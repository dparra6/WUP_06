...
We can see from the chart above that those in favor are more in the "other". When "white" is close second to favorite it, and having "blacks" being the least in favor. 
...
We can see in this detailed chart we can see that everything is out of 100, and we can see that "black" is still the smallest where "white" is drastically larger. 
...
As we look at the fisherXY tests we can see that there is a significant differnece between the "Black", "Other" and "White". While "Other" and "White" has been slightly similar. 
